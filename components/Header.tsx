    ...
    <header className="sticky top-0 z-50 bg-b-background/80 backdrop-blur-md">
      <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="#features" className="text-b-text hover:text-b-dark transition-all duration-300">What We Do</a>
      ...
      <div className={`md:hidden overflow-hidden transition-all duration-300 ${menuOpen ? 'max-h-60' : 'max-h-0'}`}>
        <div className="px-6 pb-4 flex flex-col gap-4">
          <a href="#features" onClick={() => setMenuOpen(false)} className="text-b-text hover:text-b-dark transition-all duration-300">What We Do</a>
